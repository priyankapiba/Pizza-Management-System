...
class Pizza:
    ...
    def main(sf):                 #sf is parameter as same as self
        ...
        sf.lab = Button(sf.mainf2, text="Click Here to enter the World of Pizzas", command=lambda: sf.Login(),
    ...
    def adminmain(sf):
        ...
        sf.lbldel = Label(sf.admainf2, pady=2, font=('aria', 16, 'bold'), text="Deluxe Veggie:", bg="#f2e8b8",
        ...
        sf.txtdel = Entry(sf.admainf2, font=('ariel', 16, 'bold'), textvariable=sf.Deluxe_Veggie, bd=6, width=4,
                          bg="powder blue", justify='right')
        sf.txtdel.grid(row=2, column=2)

        sf.lblvaga = Label(sf.admainf2, pady=2, font=('aria', 16, 'bold'), text="Veg Vaganza:", bg="#f2e8b8",
                           fg="#7769ad", bd=6, anchor='w')
        ...
        sf.txtvaga = Entry(sf.admainf2, font=('ariel', 16, 'bold'), textvariable=sf.Veg_Vaganza, bd=6, width=4,
                           bg="powder blue", justify='right')
        sf.txtvaga.grid(row=3, column=2)

        sf.lblpep = Label(sf.admainf2, pady=2, font=('aria', 16, 'bold'), text=" 5 Pepper:", bg="#f2e8b8", fg="#7769ad",
                          bd=6, anchor='w')
        ...
        sf.txtpep = Entry(sf.admainf2, font=('ariel', 16, 'bold'), textvariable=sf.Pepper, bd=6, width=4,
                          bg="powder blue", justify='right')
        sf.txtpep.grid(row=4, column=2)

        sf.lblmag = Label(sf.admainf2, pady=2, font=('aria', 16, 'bold'), text="Margherita:", bg="#f2e8b8",
                          fg="#7769ad", bd=6, anchor='w')
        ...
        sf.txtmag = Entry(sf.admainf2, font=('ariel', 16, 'bold'), textvariable=sf.Margherita, width=4,
        ...
        sf.lbl2 = Label(sf.admainf2, pady=2, font=('Cooper Black', 20, 'bold', 'underline'), bg="#f2e8b8",
                        text="Non-Veg Pizza", bd=10, anchor='w')
        ...
        sf.lblsup = Label(sf.admainf2, pady=2, font=('aria', 16, 'bold'), text="Non-Veg Supreme:", bg="#f2e8b8",
                          fg="#7769ad", bd=6, anchor='w')
        ...
        sf.txtsup = Entry(sf.admainf2, width=4, font=('ariel', 16, 'bold'), textvariable=sf.Non_Veg_Supreme, bd=6,
                          bg="powder blue", justify='right')
        sf.txtsup.grid(row=8, column=2)

        sf.lbltika = Label(sf.admainf2, pady=2, font=('aria', 16, 'bold'), text="Chicken Tikka:", bg="#f2e8b8",
                           fg="#7769ad", bd=6, anchor='w')
        ...
        sf.txttika = Entry(sf.admainf2, font=('ariel', 16, 'bold'), textvariable=sf.Chicken_Tikka, bd=6, width=4,
                           bg="powder blue", justify='right')
        sf.txttika.grid(row=9, column=2)

        sf.lblsaus = Label(sf.admainf2, pady=2, font=('aria', 16, 'bold'), text="Chicken Sausage:", bg="#f2e8b8",
                           fg="#7769ad", bd=6, anchor='w')
        ...
        sf.txtsaus = Entry(sf.admainf2, width=4, font=('ariel', 16, 'bold'), textvariable=sf.Chicken_Sausage, bd=6,
                           bg="powder blue", justify='right')
        sf.txtsaus.grid(row=10, column=2)

        sf.lblperi = Label(sf.admainf2, pady=2, font=('aria', 16, 'bold'), text="Chicken Peri:", bg="#f2e8b8",
                           fg="#7769ad", bd=6, anchor='w')
        ...
        sf.txtperi = Entry(sf.admainf2, font=('ariel', 16, 'bold'), width=4, textvariable=sf.Chicken_Peri, bd=6,
                           bg="powder blue", justify='right')
    ...
    def SpecialChi(sf, x):
        ...
        sf.add9 = Button(sf.spef2, text="ADD",
                         command=lambda: sf.addlist(["Roasted Chicken", sf.q9.get(), 109 * int(sf.q9.get())]),
        ...
        sf.add10 = Button(sf.spef2, text="ADD",
                          command=lambda: sf.addlist(["Chicken Meatballs", sf.q10.get(), 99 * int(sf.q10.get())]),
                          bg="#0b1335", cursor="hand2", fg="white", bd=4, font=("default", 12, 'bold'))
        ...
        sf.add11 = Button(sf.spef2, text="ADD",
                          command=lambda: sf.addlist(["Boneless Chiken", sf.q11.get(), 139 * int(sf.q11.get())]),
                          bg="#0b1335", cursor="hand2", fg="white", bd=4, font=("default", 12, 'bold'))
    ...
    def sidebev(sf, x):
        ...
        sf.add12 = Button(sf.sidef2, text="ADD",
                          command=lambda: sf.addlist(["Coke Moble", sf.q12.get(), 45 * int(sf.q12.get())]),
                          bg="#0b1335", cursor="hand2", fg="white", bd=4, font=("default", 12, 'bold'))
        ...
        sf.add13 = Button(sf.sidef2, text="ADD",
                          command=lambda: sf.addlist(["Burger Pizza", sf.q13.get(), 99 * int(sf.q13.get())]),
                          bg="#0b1335", cursor="hand2", fg="white", bd=4, font=("default", 12, 'bold'))
        ...
        sf.add14 = Button(sf.sidef2, text="ADD",
                          command=lambda: sf.addlist(["White Pasta", sf.q14.get(), 135 * int(sf.q14.get())]),
                          bg="#0b1335", cursor="hand2", fg="white", bd=4, font=("default", 12, 'bold'))
